...
Use this before the first public push. **Git root is this directory** (`gl-screen-mudi7-i18n-zh-cn/`), not the parent workspace folder.
...
git init
git remote add origin git@github.com:<user>/gl-screen-mudi7-i18n-zh-cn.git
git add .
git commit -m "Initial release: GL.iNet Mudi7 screen zh-CN ipk"
